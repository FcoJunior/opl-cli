...
The OPL has compatibility with 3 web services of git repositories, they are: [Bitbucket](https://bitbucket.org), [GitHub](https://github.com/) and [GitLab](https: // gitlab.com/) and is restricted to open source projects.
